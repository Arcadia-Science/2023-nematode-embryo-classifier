...
- __`/ground_truth/training_annotations.csv`__<br>
This file contains manual annotations of developmental stage for the cropped embryos that were used to __train__ the classification models.

- __`/ground_truth/test_annotations.csv`__<br>
This file contains manual annotations of developmental stage for the cropped embryos that were used to __evaluate__ the classification models.
...
### `/src`
This directory contains a python package called `embryostage` that includes all of the code use to process the raw images and train and evalulate models.
It mostly consists of a series of CLI scripts; please refer to the [Analysis pipeline section](#analysis-pipeline) below for details.
...
The manual annotations should be added to [this csv file](/ground_truth/training_annotations.csv). These human annotations of these embryos are treated as ground truth. The training pipeline splits the embryos in the training, validation, and test sets.
...
<img src="assets/tensorboard_validation.png" alt="" style="max-width: 600px;">

#### Validation confusion matrix over a few epochs
<img src="assets/tensorboard_validation_confusion.png" alt="" style="max-width: 600px;">

#### Test confusion matrix computed at the end of the training
<img src="assets/tensorboard_test_confusion.png" alt="" style="max-width: 600px;">
...
and a path to a JSON file of predictions generated by the `batch-classify-embryos` command discussed above. The manual annotations should adhere to the schema of the training annotations included with this repo [here](../ground_truth/training_annotations.csv).
...
### Bar plots of embryo stage distributions
These plots were generated in the notebook [here](notebooks/barplots-final-embryo-states.ipynb).
